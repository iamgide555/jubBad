...
**Spec:** `docs/archive/specs/2026-09-04-prisma-schema-design.md`
...
- This plan must not regress the NestJS scaffold's cross-boundary engine import (`docs/archive/plans/2026-09-04-nestjs-scaffold.md`, Task 2) — the full `npm test` and `npx nest build` must stay green throughout.
