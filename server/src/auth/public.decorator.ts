...
/**
 * Opts a route out of AdminGuard.
 *
 ...
 *
 * Only four routes carry this — the venue display and the player stat card,
 * both read-only. See auth.boundary.spec.ts, which pins the exact list.
 */
